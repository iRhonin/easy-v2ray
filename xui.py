...
class Xui:
    ...
    def post(self, url, *args, **kwargs):
        ...
        return requests.post(_url, *args, headers=self.headers, cookies=self.cookies, **kwargs)
    ...
    def add_vmess(self, port, path='ws'):
        ...
        config = {"add":self.domain,"aid":0,"host":self.domain,"id":str(uuid),"net":"ws","path":_path,"port":port,"ps": name,"scy":"aes-128-gcm","tls":"none","type":"none","v":2}
        link = "vmess://" + base64.b64encode(json.dumps(config, sort_keys=True).encode('utf-8')).decode()
        print(link)
